...
def download_and_compile_repo(user, repo, token, storage_client, bucket_name):
    try:
        ...
        compile_to_asm('python', 'data/source_code_files', 'data/asm_files')
...
for user, repo in tqdm_rich(repos, desc='Downloading and Compiling Repositories', unit='repo'):
    download_and_compile_repo(user, repo, token, storage_client, bucket_name)